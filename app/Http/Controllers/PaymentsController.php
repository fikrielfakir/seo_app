...
class PaymentsController extends Controller
{
     ...
     *
     */
public function webhookListener(Request $request, $gateway)
{
...
protected function handlePayPalWebhook(Request $request)
{
    ...
    // Process the webhook data (e.g., update transaction status)
    \Log::info("PayPal webhook processed: ", $request->all());
...
protected function handlePaystackWebhook(Request $request)
{
    ...
    \Log::info("Paystack webhook processed: ", $request->all());
    return response()->json(['status' => 'success']);
}
}
